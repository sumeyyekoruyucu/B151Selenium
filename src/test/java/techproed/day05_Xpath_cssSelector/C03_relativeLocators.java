...
public class C03_relativeLocators {
    public static void main(String[] args) {
        ...
        //relative locator kullanarak hybrid bikes altındaki elemente tıklayalım(ben elektrofahrrader altindakina tiklattim)
        WebElement elektrofahrrader= driver.findElement(By.xpath("(//*[@ class='a-size-base a-color-base'])[6]"));

        WebElement cruiser = driver.findElement(with(By.tagName("span")).below(elektrofahrrader));
        cruiser.click();
